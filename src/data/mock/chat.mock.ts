...
export const mockInitialMessages: ChatMsg[] = [
  {
    id: 1,
    from: "ai",
    text: "Hello Sarah! I'm your ThyroCare AI assistant. How are you feeling today? I'm here to help with any questions about your recovery, medications, diet, or symptoms.",
    time: "9:01 AM",
  },
  {
    id: 2,
    from: "user",
    text: "I've been feeling a bit fatigued lately. Is that normal after thyroid surgery?",
    time: "9:03 AM",
  },
  {
    id: 3,
    from: "ai",
    text: "Fatigue is indeed very common after thyroidectomy, especially in the first year of recovery. Several factors can contribute: your Levothyroxine dosage may need adjustment, your TSH levels might be out of optimal range, or your body is still adapting to its new hormonal balance.\n\nI'd recommend:\n• Ensure you're taking your Levothyroxine consistently each morning\n• Schedule a TSH level check if you haven't had one recently\n• Maintain a regular sleep schedule (7-9 hours)\n• Stay hydrated and eat a balanced diet\n\nIf fatigue is severe or worsening, please contact your endocrinologist. Would you like me to help you schedule a follow-up appointment?",
    time: "9:03 AM",
  },
];
