export const mockAppointments = [
  {
    ...
    note: "Fasting required 12h prior",
  },
  {
    date: "Jul 28, 2026",
  ...
  {
    date: "Oct 3, 2026",
    type: "Whole Body Scan",
    doctor: "Nuclear Medicine",
    status: "scheduled" as const,
    note: "Low-iodine diet 14 days prior",
  },
  {
    date: "Jan 15, 2026",
    type: "TSH Blood Test",
  ...
  },
  {
    ...
    doctor: "Dr. Emily Chen",
    status: "completed" as const,
    note: "Levothyroxine adjusted to 100mcg",
  },
  {
    date: "Sep 15, 2025",
    type: "Thyroidectomy Surgery",
    doctor: "Dr. Robert Park",
    status: "completed" as const,
    note: "Total thyroidectomy — DTC papillary",
  },
];
